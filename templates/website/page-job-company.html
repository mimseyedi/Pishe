                ...
                <div class="row">
                            ...
                            <div class="rounded shadow bg-white">
                                ...
                                <div class="p-4">
                                    ...
                                    <ul class="list-unstyled mb-4">
                                        <li class="h6"><i data-feather="map-pin" class="fea icon-sm text-warning me-3"></i><span class="text-muted">موقعیت :</span> ایران</li>
                                        <li class="h6"><i data-feather="link" class="fea icon-sm text-warning me-3"></i><span class="text-muted">کمپانی :</span> circleci.com</li>
                                        <li class="h6"><i data-feather="dollar-sign" class="fea icon-sm text-warning me-3"></i><span class="text-muted">درآمد:</span> 5 میلیون تومان | سالانه</li>
                                        <li class="h6"><i data-feather="users" class="fea icon-sm text-warning me-3"></i><span class="text-muted">تعداد کارمندان :</span> 200</li>
                                    </ul>
                                    <div class="d-grid">
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ApplyNow" class="btn btn-primary">اعمال کنید </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="ms-md-4">
                            ...
                            <p class="text-muted">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد..</p>
                            <p class="text-muted mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد..</p>
                            
                            <h4 class="mt-lg-5 mt-4">تیم ما :</h4>
                            <p class="text-muted mb-0">از سال 2011 شروع به کار کرده است ، ما به بیش از 200 کارمند در سراسر جهان رسیده ایم. دفتر مرکزی آن در ایران ، دفاتر ما در لندن ، توکیو ، تورنتو ، بوستون و دنور است که اعضای تیم در بیش از 50 شهر و 13 کشور کار می کنند.</p>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-4 pt-2">
                                    <a href="page-job-detail.html" class="text-dark">
                                        <div class="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                            ...
                                            <div class="content">
                                                <h4 class="title mb-0">توسعه وب سینور</h4>
                                ...
                                <div class="col-lg-6 mt-4 pt-2">
                                    <a href="page-job-detail.html" class="text-dark">
                                        <div class="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                            <div class="icon text-center rounded-circle me-3">
                                                <i data-feather="airplay" class="fea icon-ex-md text-primary"></i>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 mt-4 pt-2">
                                    <a href="page-job-detail.html" class="text-dark">
                                        <div class="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                            ...
                                            <div class="content">
                                                <h4 class="title mb-0">توسعه دهنده بک اند</h4>
                                ...
                                <div class="col-lg-6 mt-4 pt-2">
                                    <a href="page-job-detail.html" class="text-dark">
                                        <div class="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                            <div class="icon text-center rounded-circle me-3">
                                                <i data-feather="hexagon" class="fea icon-ex-md text-primary"></i>
                                            </div>
                                            <div class="content">
                                                <h4 class="title mb-0">UI طراح </h4>
                                ...
                                <div class="col-lg-6 mt-4 pt-2">
                                    <a href="page-job-detail.html" class="text-dark">
                                        <div class="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                            <div class="icon text-center rounded-circle me-3">
                                                <i data-feather="figma" class="fea icon-ex-md text-primary"></i>
                                            </div>
                                            <div class="content">
                                                <h4 class="title mb-0">طراحان تجربه کاربری</h4>
                                ...
                                <div class="col-lg-6 mt-4 pt-2">
                                    <a href="page-job-detail.html" class="text-dark">
                                        <div class="key-feature d-flex align-items-center p-3 bg-white rounded shadow">
                                            <div class="icon text-center rounded-circle me-3">
                                                <i data-feather="crop" class="fea icon-ex-md text-primary"></i>
                                            </div>
                                            <div class="content">
                                                <h4 class="title mb-0">توسعه برنامه</h4>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded shadow border-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">اکنون اعمال کنید </h5>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input name="name" id="name" type="text" class="form-control ps-5" required placeholder="نام اول :">
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input name="email" id="email" type="email" class="form-control ps-5" required placeholder="ایمیل شما :">
                                        </div>
                                    </div> 
                                </div><!--end col-->
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input name="number" id="number" type="number" class="form-control ps-5" required placeholder="تلفن شما :">
                                        </div>
                                    </div> 
                                </div><!--end col-->
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input name="subject" id="subject" class="form-control ps-5" required placeholder="عنوان:">
                                        </div>
                                    </div>                                                                               
                                </div><!--end col-->
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <textarea name="comments" id="comments" rows="4" class="form-control ps-5" required placeholder="شغل را توصیف کنید :"></textarea>
                                        </div>
                                    </div>
                                </div><!--end col-->                                    
                                <div class="col-md-12">
